...
public class FormDraw extends JFrame {
	

	private JPanel contentPane;
	private PanelDraw pnlDrawing = new PanelDraw(this);
	...
	public FormDraw() {
		...
		setTitle("Marko Galic IT80/2018");
	...
	protected void modify() {
		...
		if (selectedShape != null) {
			...
			if (selectedShape instanceof Point) {
				...
				dialog.getTxtHeight().setText("" + Integer.toString(rect.getVisina()));
				dialog.getTxtWidth().setText("" + Integer.toString(rect.getSirina()));
	...
	public PanelDraw getPnlDrawing() {
		return pnlDrawing;
	}

	public void setPnlDrawing(PanelDraw pnlDrawing) {
